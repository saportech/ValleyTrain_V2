...
const uint8_t stationMacs[NUM_STATIONS][6] = {
    ...
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // index 1 -> STATION_1
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // index 2 -> STATION_2
    {0xCC, 0x7B, 0x5C, 0x28, 0x84, 0x4C}, // index 3 -> STATION_3
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // index 4 -> STATION_4
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // index 5 -> STATION_5
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // index 6 -> STATION_6
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00}  // index 7 -> STATION_LAST
};
